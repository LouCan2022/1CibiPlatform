...
/// </summary>
/// <remarks>
/// Mirrored in BackendAPI\BuildingBlocks\BuildingBlocks\Text\CsvTextDecoder.cs (the
/// WASM app shares no project with the backend) - keep the two copies in sync.
/// </remarks>
public static class CsvTextDecoder
{
	...
	{
		// Idempotent: repeated registrations of the same provider are ignored. The
		// direct reference also roots System.Text.Encoding.CodePages (shipped in the
		// WASM output via ExcelDataReader) against publish trimming.
