        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    data_subject_face_url = table.Column<string>(type: "text", nullable: true),
                    ...
                    data_subject_full_address = table.Column<string>(type: "text", nullable: true),
                    data_subject_address_line_1 = table.Column<string>(type: "text", nullable: true),
                    data_subject_address_line_2 = table.Column<string>(type: "text", nullable: true),
                    data_subject_barangay = table.Column<string>(type: "text", nullable: true),
                    data_subject_municipality = table.Column<string>(type: "text", nullable: true),
                    data_subject_province = table.Column<string>(type: "text", nullable: true),
                    data_subject_country = table.Column<string>(type: "text", nullable: true),
                    data_subject_postal_code = table.Column<string>(type: "text", nullable: true),
                    data_subject_present_full_address = table.Column<string>(type: "text", nullable: true),
                    data_subject_present_address_line_1 = table.Column<string>(type: "text", nullable: true),
                    data_subject_present_address_line_2 = table.Column<string>(type: "text", nullable: true),
                    data_subject_present_barangay = table.Column<string>(type: "text", nullable: true),
                    data_subject_present_municipality = table.Column<string>(type: "text", nullable: true),
                    data_subject_present_province = table.Column<string>(type: "text", nullable: true),
                    data_subject_present_country = table.Column<string>(type: "text", nullable: true),
                    data_subject_present_postal_code = table.Column<string>(type: "text", nullable: true),
                    data_subject_residency_status = table.Column<string>(type: "text", nullable: true),
                    data_subject_place_of_birth = table.Column<string>(type: "text", nullable: true),
                    data_subject_pob_municipality = table.Column<string>(type: "text", nullable: true),
                    data_subject_pob_province = table.Column<string>(type: "text", nullable: true),
                    data_subject_pob_country = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
