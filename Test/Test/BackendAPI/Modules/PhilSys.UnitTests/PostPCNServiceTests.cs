...
{
	public class PostPCNServiceTests : IClassFixture<PhilSysServiceFixture>
	{
		private readonly PhilSysServiceFixture _fixture;

		public PostPCNServiceTests(PhilSysServiceFixture fixture)
		{
			_fixture = fixture;
		}
		...
		public async Task PostPCNAsync_ShouldThrow_WhenRequestFails()
		{
			...
			var service = new PostPCNService(
							_fixture.MockHttpClientFactory.Object,
							_fixture.MockPostPCNLogger.Object
						);
